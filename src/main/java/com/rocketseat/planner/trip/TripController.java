...
import com.rocketseat.planner.activity.ActivityDataDTO;
import com.rocketseat.planner.activity.ActivityRequestDTO;
import com.rocketseat.planner.activity.ActivityResponse;
import com.rocketseat.planner.activity.ActivityService;
import com.rocketseat.planner.link.LinkDataDTO;
import com.rocketseat.planner.link.LinkRequestDTO;
...
public class TripController {
    ...
    public ResponseEntity<ParticipantCreateResponse> inviteParticipant(@PathVariable UUID id,
            @RequestBody ParticipantRequestDTO payload) {
        Optional<Trip> trip = this.repository.findById(id);

        if (trip.isPresent()) {
            Trip rawTrip = trip.get();

            ParticipantCreateResponse participanteResponse = this.participantService
    ...
    public ResponseEntity<ActivityResponse> registerActivity(@PathVariable UUID id,
            @RequestBody ActivityRequestDTO payload) {
        Optional<Trip> trip = this.repository.findById(id);
    ...
    public ResponseEntity<LinkResponse> registerLink(@PathVariable UUID id, @RequestBody LinkRequestDTO payload) {
        Optional<Trip> trip = this.repository.findById(id);
